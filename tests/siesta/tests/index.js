...
Harness.start(
...

    {
        ...
        autoCheckGlobals    : false,
        preload             : [
            '../../extjs-5.0.0/packages/ext-theme-classic/build/resources/ext-theme-classic-all-debug.css',
            '../../extjs-5.0.0/build/ext-all-debug.js',
            '../siesta-all.js',
            'lib/Siesta/Test/AssertionsTranslator.js'
        ],
        // Run only these smoke tests everywhere except IE9 for now
        items               : ($.browser.msie && Number(/^(\d+)/.exec($.browser.version)[ 1 ]) < 10) ? [] : [
